...
<!-- jQuery UI 1.11.4 -->
<script src="{{ asset('clinic/plugins/jquery-ui/jquery-ui.min.js') }}"></script>
...
<!-- ChartJS -->
<script src="{{ asset('clinic/plugins/chart.js/Chart.min.js') }}"></script>
<!-- Sparkline -->
<script src="{{ asset('clinic/plugins/sparklines/sparkline.js') }}"></script>
<!-- JQVMap -->
<script src="{{ asset('clinic/plugins/jqvmap/jquery.vmap.min.js') }}"></script>
<script src="{{ asset('clinic/plugins/jqvmap/maps/jquery.vmap.usa.js') }}"></script>
<!-- jQuery Knob Chart -->
<script src="{{ asset('clinic/plugins/jquery-knob/jquery.knob.min.js') }}"></script>
<!-- daterangepicker -->
<script src="{{ asset('clinic/plugins/moment/moment.min.js') }}"></script>
<script src="{{ asset('clinic/plugins/daterangepicker/daterangepicker.js') }}"></script>
<!-- Tempusdominus Bootstrap 4 -->
<script src="{{ asset('clinic/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') }}"></script>
<!-- Summernote -->
<script src="{{ asset('clinic/plugins/summernote/summernote-bs4.min.js') }}"></script>
<!-- overlayScrollbars -->
<script src="{{ asset('clinic/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js') }}"></script>
<!-- AdminLTE for demo purposes -->
<script src="{{ asset('clinic/dist/js/demo.js') }}"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="{{ asset('clinic/dist/js/pages/dashboard.js') }}"></script>
</body>
</html>
